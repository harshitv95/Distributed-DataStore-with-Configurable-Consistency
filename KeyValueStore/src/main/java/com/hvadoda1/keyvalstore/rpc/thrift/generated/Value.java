...
public class Value implements org.apache.thrift.TBase<Value, Value._Fields>, java.io.Serializable, Cloneable,
		Comparable<Value>, IValue<String> {
  ...
  public @org.apache.thrift.annotation.Nullable ValueMetadata meta; // optional
  ...
  private static final _Fields optionals[] = {_Fields.META,_Fields.VALUE};
  ...
  static {
    ...
    tmpMap.put(_Fields.META, new org.apache.thrift.meta_data.FieldMetaData("meta", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ValueMetadata.class)));
  ...
  public Value(Value other) {
    if (other.isSetMeta()) {
      this.meta = new ValueMetadata(other.meta);
    }
    if (other.isSetValue()) {
  ...
  @org.apache.thrift.annotation.Nullable
  public ValueMetadata getMeta() {
    return this.meta;
  }

  public Value setMeta(@org.apache.thrift.annotation.Nullable ValueMetadata meta) {
    this.meta = meta;
    return this;
  }
  ...
  public Value setValue(@org.apache.thrift.annotation.Nullable java.lang.String value) {
    this.value = value;
    return this;
  }
