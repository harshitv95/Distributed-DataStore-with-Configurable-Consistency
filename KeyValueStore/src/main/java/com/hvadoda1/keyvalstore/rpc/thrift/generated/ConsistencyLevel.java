...
public enum ConsistencyLevel implements org.apache.thrift.TEnum, IConsistencyLevel {
	ONE(0, 1, 1, 1, false), QUORUM(1, -1, -1, -1, true);

	private final int value;
	private final int minWriteReplicas, numReadReplicas, maxWriteReplicas;
	private final boolean shouldSaveMissedUpdates;

	private ConsistencyLevel(int value, int numReadReplicas, int minWriteReplicas, int maxWriteReplicas,
		...
		this.shouldSaveMissedUpdates = shouldSaveMissedUpdates;
	}
	...
	@Override
	public boolean shouldSaveMissedUpdates() {
		return shouldSaveMissedUpdates;
	}
}
