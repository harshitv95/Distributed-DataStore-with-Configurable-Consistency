...
public enum ConsistencyLevel implements org.apache.thrift.TEnum, IConsistencyLevel {
	ONE(0, 1, 1), QUORUM(1, -1, -1);

	private final int value;
	private final int numWriteReplicas, numReadReplicas;

	private ConsistencyLevel(int value, int numWriteReplicas, int numReadReplicas) {
		this.value = value;
		this.numWriteReplicas = numWriteReplicas;
	...
	@Override
	public int numWriteReplicas() {
		return numWriteReplicas < 0 ? Config.getMaxNumWriteReplicas() : numWriteReplicas;
	}

	@Override
	public int numReadReplicas() {
		return numReadReplicas < 0 ? Config.getMaxNumWriteReplicas() : numReadReplicas;
	}
}
